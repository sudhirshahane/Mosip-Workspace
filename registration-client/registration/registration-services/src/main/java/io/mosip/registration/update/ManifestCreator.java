...
public class ManifestCreator {
    ...
    public static void main(String[] args) {
        ...
        String libraryFolderPath = "/home/trueid/Desktop/workspace/sai/registration-client/registration";
        String targetPath = "/home/trueid/Desktop/workspace/sai/registration-client/registration/registration-services/target";
    ...
    private static void addEntryInManifest(File file) throws Exception {
      //  String hashText = HMACUtils2.digestAsPlainText(FileUtils.readFileToByteArray(file));
        ...
        attribute.put(Attributes.Name.CONTENT_TYPE, "1.2.0");
