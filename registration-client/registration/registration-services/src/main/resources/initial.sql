...
CREATE TABLE "REG"."DOC_TYPE" ("CODE" VARCHAR(36) NOT NULL, "NAME" VARCHAR(300) NOT NULL, "DESCR" VARCHAR(300), "LANG_CODE" VARCHAR(3) NOT NULL, "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP);
...
-- FOREIGN
INSERT INTO "REG"."PROCESS_SPEC" VALUES ('NEW','SCHEMA_NEW','0.1',1,false,'NEW',true);

INSERT INTO "REG"."PROCESS_SPEC" VALUES ('UPDATE','SCHEMA_UPDATE','0.1',2,false,'UPDATE',true);

INSERT INTO "REG"."PROCESS_SPEC" VALUES ('LOST','SCHEMA_LOST','0.1',3,false,'LOST',true);

INSERT INTO "REG"."PROCESS_SPEC" VALUES ('BIOMETRIC_CORRECTION','SCHEMA_CORRECTION','0.1',4,false,'CORRECTION',true);

INSERT INTO "REG"."IDENTITY_SCHEMA" VALUES ('NEW','0.1','SCHEMA_NEW.json','file_hash',current timestamp);
INSERT INTO "REG"."IDENTITY_SCHEMA" VALUES ('UPDATE','0.1','SCHEMA_UPDATE.json','file_hash',current timestamp);
INSERT INTO "REG"."IDENTITY_SCHEMA" VALUES ('LOST','0.1','SCHEMA_LOST.json','file_hash',current timestamp);
INSERT INTO "REG"."IDENTITY_SCHEMA" VALUES ('BIOMETRIC_CORRECTION','0.1','SCHEMA_CORRECTION.json','file_hash',current timestamp);


-- above for register Proccess_Schecma
