...
public class HeaderController extends BaseController {
	...
	public void initialize() {
		...
		try {
			...
			String	settingsByRole1="[{\"name\":\"scheduledjobs\",\"description\":{\"ara\":\"Ø¥Ø¹Ø¯Ø§Ø¯Ø§ØªØ§Ù„ÙˆØ¸Ø§Ø¦ÙØ§Ù„Ù…Ø¬Ø¯ÙˆÙ„Ø©\",\"fra\":\"ParamÃ¨tresdestravauxplanifiÃ©s\",\"eng\":\"ScheduledJobsSettings\",\"hin\":\"अनुसूचितनौकरीसेटिंग्स\"},\"label\":{\"ara\":\"Ø¥Ø¹Ø¯Ø§Ø¯Ø§ØªØ§Ù„ÙˆØ¸Ø§Ø¦ÙØ§Ù„Ù…Ø¬Ø¯ÙˆÙ„Ø©\",\"fra\":\"ParamÃ¨tresdestravauxplanifiÃ©s\",\"eng\":\"ScheduledJobsSettings\",\"hin\":\"अनुसूचितनौकरीसेटिंग्स\"},\"fxml\":\"ScheduledJobsSettings.fxml\",\"icon\":\"scheduledjobs.png\",\"order\":\"1\",\"shortcut-icon\":\"scheduledjobs-shortcut.png\",\"access-control\":[\"REGISTRATION_SUPERVISOR\"]},{\"name\":\"globalconfigs\",\"description\":{\"ara\":\"Ø¥Ø¹Ø¯Ø§Ø¯Ø§ØªØ§Ù„ØªÙƒÙˆÙŠÙ†Ø§Ù„Ø¹Ø§Ù…Ø©\",\"fra\":\"ParamÃ¨tresdeconfigurationglobale\",\"eng\":\"GlobalConfigSettings\",\"hin\":\"वैश्विकविन्याससेटिंग्स\"},\"label\":{\"ara\":\"Ø¥Ø¹Ø¯Ø§Ø¯Ø§ØªØ§Ù„ØªÙƒÙˆÙŠÙ†Ø§Ù„Ø¹Ø§Ù…Ø©\",\"fra\":\"ParamÃ¨tresdeconfigurationglobale\",\"eng\":\"GlobalConfigSettings\",\"hin\":\"वैश्विकविन्याससेटिंग्स\"},\"fxml\":\"GlobalConfigSettings.fxml\",\"icon\":\"globalconfigs.png\",\"order\":\"2\",\"shortcut-icon\":\"globalconfigs-shortcut.png\",\"access-control\":[\"REGISTRATION_SUPERVISOR\",\"REGISTRATION_OFFICER\"]},{\"name\":\"devices\",\"description\":{\"ara\":\"Ø¥Ø¹Ø¯Ø§Ø¯Ø§ØªØ§Ù„Ø¬Ù‡Ø§Ø²\",\"fra\":\"RÃ©glagesdel'appareil\",\"eng\":\"DeviceSettings\",\"hin\":\"उपकरणसेटिंग्स\"},\"label\":{\"ara\":\"Ø¥Ø¹Ø¯Ø§Ø¯Ø§ØªØ§Ù„Ø¬Ù‡Ø§Ø²\",\"fra\":\"RÃ©glagesdel'appareil\",\"eng\":\"DeviceSettings\",\"eng\":\"DeviceSettings\"},\"fxml\":\"DeviceSettings.fxml\",\"icon\":\"devices.png\",\"order\":\"3\",\"shortcut-icon\":\"devices-shortcut.png\",\"access-control\":[\"REGISTRATION_SUPERVISOR\",\"REGISTRATION_OFFICER\"]}]";
			objectMapper = new ObjectMapper();
			SettingsSchema[] settingsSchema2 =objectMapper.readValue(settingsByRole1, SettingsSchema[].class);
...
//					.getSettingsSchema(identitySchemaService.getLatestEffectiveSchemaVersion());
			List<SettingsSchema> settingsSchema=Arrays.asList(settingsSchema2);
