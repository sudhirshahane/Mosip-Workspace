...
\COPY master.app_detail (id,name,descr,lang_code,is_active,cr_by,cr_dtimes) FROM '/home/trueid/Desktop/workspace/admin/admin-services/db_scripts/mosip_master/dml/master-app_detail.csv' delimiter ',' HEADER  csv;
